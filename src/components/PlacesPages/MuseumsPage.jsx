      ...
      <main>
        <section className="places-hero">
          <div className="container">
            <h1 className="places-title">Музеи</h1>
        ...
        <section className="places-content">
          <div className="container">
            <div className="places-description">
              <h2>О музеях Москвы</h2>
              <p>Текстовая заглушка о музеях Москвы. Здесь будет подробная информация о культурных учреждениях столицы, их коллекциях, истории и значимости.</p>
              
              <div className="places-details">
                <h3>Дополнительная информация</h3>
                <p>Заглушка текста о музеях. Этот текст можно заменить на реальное описание когда оно появится.</p>
